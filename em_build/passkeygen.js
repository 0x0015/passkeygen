...
wasmBinaryFile = "passkeygen.wasm";
...
function Element_getById(hash, id) {
 JS_Man["A" + hash] = document.getElementById(UTF8ToString(id));
}

function Element_getVal(hash, id, length) {
 stringToUTF8(JS_Man["A" + hash].value, id, length + 1);
}

function Element_getValLen(hash) {
 return (lengthBytesUTF8(JS_Man["A" + hash].value));
}

function Element_setVal(hash, id) {
 JS_Man["A" + hash].value = UTF8ToString(id);
}

function Element_getInnerHTML(hash, id, length) {
 stringToUTF8(JS_Man["A" + hash].innerHTML, id, length + 1);
}

function Element_getInnerHTMLLen(hash) {
 return (lengthBytesUTF8(JS_Man["A" + hash].innerHTML));
}

function Element_setInnerHTML(hash, id) {
 JS_Man["A" + hash].innerHTML = UTF8ToString(id);
}

function Element_getDisabled(hash) {
 return (JS_Man["A" + hash].disabled);
}

function Element_setDisabled(hash, value) {
 JS_Man["A" + hash].disabled = value;
}

function Element_getChecked(hash) {
 return (JS_Man["A" + hash].checked);
}

function Element_setChecked(hash, value) {
 JS_Man["A" + hash].checked = value;
}

function Element_setOnclick(hash, funcHash) {
...
var _strftime = (s, maxsize, format, tm) => {
 var tm_zone = _asan_js_load_4u((((tm) + (40)) >> 2));
 var date = {
...
var wasmImports = {
 /** @export */ Element_AssignChildElement: Element_AssignChildElement,
 /** @export */ Element_callOnclick: Element_callOnclick,
 /** @export */ Element_getById: Element_getById,
 /** @export */ Element_getChecked: Element_getChecked,
 /** @export */ Element_getDisabled: Element_getDisabled,
 /** @export */ Element_getInnerHTML: Element_getInnerHTML,
 /** @export */ Element_getInnerHTMLLen: Element_getInnerHTMLLen,
 /** @export */ Element_getStyle: Element_getStyle,
 /** @export */ Element_getStyleLen: Element_getStyleLen,
 /** @export */ Element_getVal: Element_getVal,
 /** @export */ Element_getValLen: Element_getValLen,
 /** @export */ Element_setChecked: Element_setChecked,
 /** @export */ Element_setDisabled: Element_setDisabled,
 /** @export */ Element_setInnerHTML: Element_setInnerHTML,
 /** @export */ Element_setOnclick: Element_setOnclick,
 /** @export */ Element_setStyle: Element_setStyle,
 /** @export */ Element_setVal: Element_setVal,
 /** @export */ JS_Man_allocateVar: JS_Man_allocateVar,
 /** @export */ JS_Man_construct: JS_Man_construct,
 /** @export */ JS_Man_evalJS: JS_Man_evalJS,
 /** @export */ JS_Man_freeVar: JS_Man_freeVar,
...
var ___start_em_js = Module["___start_em_js"] = 10039565;

var ___stop_em_js = Module["___stop_em_js"] = 10041788;
...
var unexportedSymbols = [ "run", "addOnPreRun", "addOnInit", "addOnPreMain", "addOnExit", "addOnPostRun", "addRunDependency", "removeRunDependency", "FS_createFolder", "FS_createPath", "FS_createLazyFile", "FS_createLink", "FS_createDevice", "FS_readFile", "out", "err", "callMain", "abort", "wasmMemory", "wasmExports", "stackAlloc", "stackSave", "stackRestore", "getTempRet0", "setTempRet0", "WasmOffsetConverter", "writeStackCookie", "checkStackCookie", "convertI32PairToI53Checked", "ptrToString", "zeroMemory", "exitJS", "getHeapMax", "abortOnCannotGrowMemory", "ENV", "MONTH_DAYS_REGULAR", "MONTH_DAYS_LEAP", "MONTH_DAYS_REGULAR_CUMULATIVE", "MONTH_DAYS_LEAP_CUMULATIVE", "isLeapYear", "arraySum", "addDays", "ERRNO_CODES", "ERRNO_MESSAGES", "DNS", "Protocols", "Sockets", "initRandomFill", "randomFill", "timers", "warnOnce", "UNWIND_CACHE", "convertPCtoSourceLocation", "withBuiltinMalloc", "readEmAsmArgsArray", "getExecutableName", "handleException", "keepRuntimeAlive", "asyncLoad", "alignMemory", "mmapAlloc", "wasmTable", "noExitRuntime", "getCFunc", "freeTableIndexes", "functionsInTableMap", "setValue", "getValue", "PATH", "PATH_FS", "UTF8Decoder", "UTF8ArrayToString", "UTF8ToString", "stringToUTF8Array", "stringToUTF8", "lengthBytesUTF8", "intArrayFromString", "stringToAscii", "UTF16Decoder", "stringToNewUTF8", "stringToUTF8OnStack", "writeArrayToMemory", "JSEvents", "specialHTMLTargets", "currentFullscreenStrategy", "restoreOldWindowedStyle", "demangle", "demangleAll", "jsStackTrace", "ExitStatus", "getEnvStrings", "doReadv", "doWritev", "promiseMap", "uncaughtExceptionCount", "exceptionLast", "exceptionCaught", "ExceptionInfo", "findMatchingCatch", "Browser", "wget", "SYSCALLS", "preloadPlugins", "FS_createPreloadedFile", "FS_modeStringToFlags", "FS_getMode", "FS_stdin_getChar_buffer", "FS_stdin_getChar", "FS", "FS_createDataFile", "MEMFS", "TTY", "PIPEFS", "SOCKFS", "tempFixedLengthArray", "miniTempWebGLFloatBuffers", "miniTempWebGLIntBuffers", "GL", "emscripten_webgl_power_preferences", "AL", "GLUT", "EGL", "GLEW", "IDBStore", "SDL", "SDL_gfx", "allocateUTF8", "allocateUTF8OnStack" ];
